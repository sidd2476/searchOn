...
browser.contextMenus.create({  id: "ne",  title: " News",  contexts: ["selection"]   });

            browser.contextMenus.create({  id: "timesofindia",  title: " Times of india",  contexts: ["selection"] ,parentId : "ne"   });

            browser.contextMenus.create({  id: "hindustantimes",  title: " Hindustan Times",  contexts: ["selection"] , parentId : ""  });

            browser.contextMenus.create({  id: "bbc",  title: " BBC",  contexts: ["selection"] , parentId : "ne"  });

            browser.contextMenus.create({  id: "ndtv",  title: " NDTV",  contexts: ["selection"] , parentId : "ne"  });

            browser.contextMenus.create({  id: "theindianexpress",  title: " The Indian Express",  contexts: ["selection"] , parentId : "ne"  });

            browser.contextMenus.create({  id:"thehindu",  title:"TheHindu",  contexts: ["selection"],  parentid:"ne" });
...
function findChoice(searchEngText)
{
          ...
          else if(searchEngText == 'timesofindia')
          {  return 'https://timesofindia.indiatimes.com/topic/,l';  }

          else if(searchEngText == 'hindustantimes')
          {  return 'http://www.hindustantimes.com/queryResult/xmlResults;jsessionid=';  }

          else if(searchEngText == 'bbc')
          {  return 'https://www.bbc.co.uk/search?q=';  }

          else if(searchEngText == 'ndtv')
          {  return 'https://www.ndtv.com/topic/';  }

          else if(searchEngText == 'theindianexpress')
          {  return 'http://indianexpress.com/?s=';  }
          
          else if(searchEngText == 'thehindu')
              {return 'http://www.thehindu.com/search/?q='}
